...
headers = faqs.select(
    ".text-header-landing.text-subHeader.text-lg.font-semibold.leading-tight.mt-8.pb-4.border-b.border-black"
)
...
# Header counts
header_counts = {"Account": 19, "Auto Debit": 5, "Pay with Grace": 18, "Limit Boost": 7}
...
filepath = Path(__file__).parent / "billease_faq.csv"
